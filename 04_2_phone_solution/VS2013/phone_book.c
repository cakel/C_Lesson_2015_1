...
void deleteData(void)
{
	...
	if (tNode != NULL)
	{
		...
		if (yn == 'y')
		{
			...
			{
				// 삭제할 Node 가 최상위 Head
				// Head Node 의 다음 Node 를 Head 로 가리킨다.
				head = head->nNode;
			}
			else
			{
